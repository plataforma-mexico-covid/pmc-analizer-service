...
('julio_cesar_24@hotmail.com', '$2a$10$Zah8wiwQ4lo9ZoGubLjQSOsPj7KTahQcTqJV0U6J/iLqOmmYfbG96', 1, 1),
('myfriendnardation@gmail.com', '$2a$10$Zah8wiwQ4lo9ZoGubLjQSOsPj7KTahQcTqJV0U6J/iLqOmmYfbG96', 1, 1),
('jc.lechuga.greenbyte@gmail.com', '$2a$10$Zah8wiwQ4lo9ZoGubLjQSOsPj7KTahQcTqJV0U6J/iLqOmmYfbG96', 1, 1),
('contacto@pmc.mx', 'p4Ssword', 0, 0);

INSERT INTO USER_ROLE (ID, USERNAME, ROLE) VALUES
(1, 'admin@pmc.mx', 'ADMIN'),
(2, 'admin@pmc.mx', 'CITIZEN'),
(3, 'julio_cesar_24@hotmail.com', 'CITIZEN'),
(4, 'myfriendnardation@gmail.com', 'CITIZEN'),
(5, 'jc.lechuga.greenbyte@gmail.com', 'CITIZEN');
...
(4, 'Cos�o', 'Cos�o', '004', 01),
(5, 'El Llano', 'El Llano', '010', 01),
(6, 'Jes�s Mar�a', 'Jes�s Mar�a', '005', 01),
(7, 'Pabell�n de Arteaga', 'Pabell�n de Arteaga', '006', 01),
(8, 'Rinc�n de Romos', 'Rinc�n de Romos', '007', 01),
(9, 'San Francisco de los Romo', 'San Francisco de los Romo', '011', 01),
(10, 'San Jos� de Gracia', 'San Jos� de Gracia', '008', 01),
(11, 'Tepezal�', 'Tepezal�', '009', 01),
...
(67, 'Torre�n', 'Torre�n', '035', 05),
(68, 'Viesca', 'Viesca', '036', 05),
(69, 'Villa Uni�n', 'Villa Uni�n', '037', 05),
(70, 'Zaragoza', 'Zaragoza', '038', 05),
(269, 'Azcapotzalco', 'Azcapotzalco', '002', 09),
(270, 'Benito Ju�rez', 'Benito Ju�rez', '014', 09),
(271, 'Coyoac�n', 'Coyoac�n', '003', 09),
(272, 'Cuajimalpa de Morelos', 'Cuajimalpa de Morelos', '004', 09),
(273, 'Cuauht�moc', 'Cuauht�moc', '015', 09),
...
(1, 'Jorge', 'Cruz', 'Lopez', 'julio_cesar_24@hotmail.com', 1),
(2, 'Jose', 'Soto', 'Torres', 'myfriendnardation@gmail.com', 1),
(3, 'Juls', 'Plataforma', 'Torres', 'jc.lechuga.greenbyte@gmail.com', 1);

INSERT INTO CIUDADANO_CONTACTO (ID, CIUDADANO_ID, TIPO_CONTACTO, CONTACTO) VALUES
(1, 1, 'TELEFONO_MOVIL', '5544332211'),
(2, 1, 'TWITTER', '@Jorge'),
...
(2, 'CALLE DESCONOCIDA', '16', '', 'Alarragueta', '06200', 273, 19.4294462, -99.1594158),
(3, 'MUSEO SOUMAYA', '211', '', 'Ferreria', '12300', 273, 19.4562262, -99.202573);
...
(1, 'Necesito ir a mi cita de hemodi�lisis1 16:00', 1, 1, 3, 'SOLICITA', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA'),
(2, 'Necesito medicamento para diabetes', 1, 1, 3, 'SOLICITA', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'PENDIENTE'),
(3, 'Necesito mascarillas n95', 1, 1, 3, 'SOLICITA', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'EN_PROCESO'),
(4, 'Ofrezco viveres 08:00 a 23:00', 2, 2, 3, 'OFRECE', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA'),
(5, 'Ofrezco ayuda medica online 08:00 a 17:00', 3, 3, 3, 'OFRECE', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA');
